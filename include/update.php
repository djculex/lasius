 ...
 * @return bool|null
 */
function xoops_module_update_lasius($module, $prev_version = null)
{
    $ret = null;
    if ($prev_version < 10) {
        $ret = update_lasius_v10($module);
    }

    $ret = lasius_check_db($module);

    //check upload directory
	include_once __DIR__ . '/install.php';
    $ret = xoops_module_install_lasius($module);
 ...
 * @return bool
 */
function update_lasius_v10($module)
{
    global $xoopsDB;
 ...
 * @return bool
 */
function lasius_check_db($module)
{
    $ret = true;
    ...
    $table   = $GLOBALS['xoopsDB']->prefix('lasius_images');
    $field   = 'img_exif';
