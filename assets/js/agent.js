jQuery( document ).ready(function() {
	...
	jQuery( window ).on( "load", function() {
		console.log("window loaded");
			...
			var interValStart_topposters = setInterval(SystemBlock_checkNewMembers, 5000); 
			...
			function SystemBlock_checkOnlineUsers() {
					...
					*/
					jQuery('div:contains("' + Lasius_reviveonlineusersblock_title + '")').next(".blockContent").load(Lasius_systemurl + "/agent.php?type=onlinenow", function() {
						console.log('replace online users block.');
